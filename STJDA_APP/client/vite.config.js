...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'STJDA Glucose Gaurdian System',
        short_name: 'STJDA-GGS',
        description: 'A continuous monitoring system for glucose levels',
        theme_color: '#ffffff',
        background_color: '#ffffff',
        display: 'standalone',
        start_url: '/STJDA.org/Gaurdian/', // start URL 
        id: '/STJDA.org/Gaurdian/', //  a consistent ID for the app
        scope: '/Gaurdian/', // the scope to restrict what URLs are considered part of the app
        icons: [
  ...
  build: {
    ...
    base: '/STSJ_GlucoseGaurdian/', // Base public path set to match the GitHub repository name
  },
});