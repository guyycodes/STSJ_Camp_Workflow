export class GenericTreeNodeWithMemory {
    constructor() {
        this.valueInt = null;
        this.valueString = '';
        this.children = [];
    ...
    addChild(node) {
        if (node instanceof GenericTreeNodeWithMemory) {
            node.parent = this; // Set the parent for the child
            this.children.push(node);
        } else {
            console.log("Can only add an instance of GenericTreeNodeWithMemory as a child.");
        }
    }
